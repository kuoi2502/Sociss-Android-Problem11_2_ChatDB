    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                com.demo.socissproblem11_2.utils.Utils.closeKeyboard(getContext(), signInButton);
                attemptLogin();
            }
        });
        ...
        createAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                com.demo.socissproblem11_2.utils.Utils.closeKeyboard(getContext(), createAccount);
        ...
        com.demo.socissproblem11_2.utils.Utils.closeKeyboard(getContext(), mEmail);
    ...
    private void login() {
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                if (mCallback != null) {
                    com.demo.socissproblem11_2.utils.Utils.saveLocalUser(getContext(), com.demo.socissproblem11_2.utils.Constants.DEFAULT_USER,
